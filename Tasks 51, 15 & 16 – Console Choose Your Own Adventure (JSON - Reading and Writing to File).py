...
def get_username():
    while True:
        ...
        if name:  # leaning on truthy/falsey values. "" resolves to false
            return name
        else:
...
def get_step_dict(step, choice):
    """
    "cottage": {
                "text": "An old woman opens the door and offers you shelter.",
                "options": [
                    { "choice_text": "Accept her offer", "next_id": "safe_end" },
                    {
                        "choice_text": "Politely decline and leave",
                        "next_id": "wolves"
                    }
                ]
            },
